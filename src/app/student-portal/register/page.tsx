  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Create your student account to access the portal."
      />
          ...
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel htmlFor="emailRegisterStudent">Email</FormLabel>
                      <FormControl>
                        <Input id="emailRegisterStudent" type="email" placeholder="your.email@example.com" {...field} icon={<Mail className="h-4 w-4 text-muted-foreground" />} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel htmlFor="passwordRegisterStudent">Password</FormLabel>
                      <FormControl>
                        <Input id="passwordRegisterStudent" type="password" placeholder="Create a Password" {...field} icon={<Lock className="h-4 w-4 text-muted-foreground" />} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel htmlFor="confirmPasswordRegisterStudent">Confirm Password</FormLabel>
                      <FormControl>
                        <Input id="confirmPasswordRegisterStudent" type="password" placeholder="Confirm Your Password" {...field} icon={<Lock className="h-4 w-4 text-muted-foreground" />} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <div className="text-center text-sm text-muted-foreground">
              ...
              <Button asChild variant="link" size="sm" className="px-0 text-accent hover:underline">
                <Link href="/student-portal">Login Here</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
