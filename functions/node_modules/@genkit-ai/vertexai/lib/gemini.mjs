...
const GeminiConfigSchema = GenerationCommonConfigSchema.extend({
  maxOutputTokens: z.number().min(1).max(8192).describe(GenerationCommonConfigDescriptions.maxOutputTokens).optional(),
  temperature: z.number().min(0).max(1).describe(
    GenerationCommonConfigDescriptions.temperature + " The default value is 0.2."
  ).optional(),
